...
part 'tag_list_api_service.chopper.dart';

@ChopperApi(baseUrl: '/v2')
abstract class TagListApiService extends ChopperService {
...
//      @Query('sort[count]') String sort = "count"}
  ...
  static TagListApiService create() {
    ...
    return _$TagListApiService(client);
  }
}
